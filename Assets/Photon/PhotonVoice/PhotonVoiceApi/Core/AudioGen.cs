...
namespace Photon.Voice
{
    public static partial class AudioUtil
    {
        ...
        public class ToneAudioReader<T> : Photon.Voice.IAudioReader<T>
        {
        ...
        public class ToneAudioPusher<T> : Photon.Voice.IAudioPusher<T>
        {
            /// <summary>Create a new ToneAudioReader instance</summary>
            /// <param name="frequency">Frequency of the generated tone (in Hz).</param>
...
#endif
            Action<T[]> callback;
            Voice.ObjectFactory<T[], int> bufferFactory;
