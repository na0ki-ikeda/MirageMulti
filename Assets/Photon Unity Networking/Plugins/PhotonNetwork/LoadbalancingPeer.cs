...
internal class LoadBalancingPeer : PhotonPeer
{
    ...
    public virtual bool OpGetRegions(string appId)
    {
        ...
        return this.SendOperation(OperationCode.GetRegions, parameters, new SendOptions { Channel = 0, Encrypt = true, Reliability = true });
    }
    ...
    public virtual bool OpAuthenticate(string appId, string appVersion, AuthenticationValues authValues, string regionCode, bool getLobbyStatistics)
    {
        ...
        bool sent = this.SendOperation(OperationCode.Authenticate, opParameters, new SendOptions { Reliability = true, Encrypt = this.IsEncryptionAvailable });
        if (!sent)
        {
    ...
    public virtual bool OpChangeGroups(byte[] groupsToRemove, byte[] groupsToAdd)
    {
        ...
        return this.SendOperation((byte)OperationCode.ChangeGroups, opParameters, SendOptions.SendReliable);
    }
    ...
    public virtual bool OpRaiseEvent(byte eventCode, object customEventContent, bool sendReliable, RaiseEventOptions raiseEventOptions)
    {
        ...
        return this.SendOperation(OperationCode.RaiseEvent, this.opParameters, new SendOptions { Reliability = sendReliable, Channel = raiseEventOptions.SequenceChannel, Encrypt = raiseEventOptions.Encrypt });
    }
